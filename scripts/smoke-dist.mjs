...
for (const expected of [
  ...
  "Hafiza Disa Aktar",
  "Tum Hafizayi ZIP Indir",
  "Henuz disa aktarim yapilmadi",
  "Oturum Akisina Git",
...
for (const legacyTerm of [
  ...
  assert.ok(
    !normalizedBundleText.includes(legacyTerm),
    `Gorunur UI eski urun terimini tasimamali: ${legacyTerm}`
  );
}
